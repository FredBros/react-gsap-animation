    ...
    <>
      <StyledTextSection ref={textSectionTriggerRef}>
        <p className="text__intro">
          Cred air plant cardigan bushwick, lo-fi before they sold out jianbing
          letterpress semiotics mixtape typewriter bicycle rights.Cred schlitz
          freegan shaman, edison bulb waistcoat thundercats bitters meh.
        </p>
      </StyledTextSection>
