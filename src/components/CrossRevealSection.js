...
function CrossRevealSection({face, landscape, name, job, sentenceOne, sentenceTwo, crossreveal}) {
  // animate the container one way
  const containerRef = useRef(null);
  // and animate image the opposite way at the same time
  ...
  useEffect(() => {
    ...
    crossRevealTween
      ...
      // animate the image in the opposite way at the same time
      .fromTo(
        imageRef.current,
        { [crossreveal]: -100, x: 0 },
        { [crossreveal]: 0 },
